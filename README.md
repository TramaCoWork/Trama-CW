...
**Secrets:** `SSH_KEY`, `SSH_HOST`, `SSH_PORT`, `SSH_USER`, `DEPLOY_PATH`, `DATABASE_URL`, `JWT_SECRET`, `MERCADOPAGO_ACCESS_TOKEN`, `SMTP_HOST`, `SMTP_USER`, `SMTP_PASS`

**Variables:** `PORT`, `FRONTEND_URL`, `SUBSCRIPTION_NOTIFICATION_URL`, `TRIAL_DAYS`, `PAYMENT_MODE`, `LOG_RETENTION_DAYS`
