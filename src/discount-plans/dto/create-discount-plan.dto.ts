...
export class CreateDiscountPlanDto {
  ...
  @ApiPropertyOptional({ default: true, description: 'Activa o desactiva manualmente el plan' })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;

  @ApiProperty({ example: '2026-07-01T00:00:00.000Z', description: 'Fecha de inicio de vigencia' })
  @IsDateString()
  fromDate: string;

  @ApiProperty({ example: '2026-07-31T23:59:59.999Z', description: 'Fecha de fin de vigencia' })
  @IsDateString()
  toDate: string;

  @ApiPropertyOptional({ description: 'Cantidad de ciclos de facturación a aplicar' })
  @IsOptional()
  @IsInt()
  @Min(1)
